...
let t = wrapText('The String global object is a constructor for strings, or a sequence of characters.', 26)
...
function* getFigureRectangles(figure) {
    ...
    for (let index = 0; index < answer.length; index++) yield answer[index];
}

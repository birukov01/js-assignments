...
function findStringInSnakingPuzzle(puzzle, searchStr) {
    ...
    for (let y = 0; y < puzzle.length; ++y) {
        for (let x = 0; x < puzzle[0].length; ++x) {
            if (checkRoute(x, y, searchStr, new RouteMap())) return true;
        }
    }
    return false;
}
